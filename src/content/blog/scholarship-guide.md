...
- **Grace period ของ J-1 = 30 วัน** นับจากวันสิ้นสุดโปรแกรม (program end date) ที่ระบุใน DS-2019 — น้อยกว่า F-1 ที่ได้ 60 วัน ช่วง 30 วันนี้มีไว้ **เพื่อเดินทางออกจากสหรัฐฯ เท่านั้น**
- **สิทธิประโยชน์หรือการเปลี่ยนแปลงสถานะใดๆ ต้องยื่นก่อนวันสิ้นสุดโปรแกรมที่ระบุใน DS-2019** ไม่ใช่ก่อนหมด grace period — พอเลยวันสิ้นสุดโปรแกรมไปแล้ว จะยื่นเรื่องอะไรไม่ได้อีก เหลือแค่สิทธิ์อยู่ต่อ 30 วันเพื่อเก็บของและบินกลับ ถ้าวางแผนจะขออะไรต่อ ต้องนับถอยหลังจาก**วันสิ้นสุดโปรแกรม** ไม่ใช่วันหมดวีซ่า

### หาที่ฝึกงาน: ต้องผ่าน Academic Training (AT)

ถ้าหลักสูตรบังคับให้**ฝึกงาน (internship)** เพื่อจบการศึกษา ต้องรู้ไว้ตั้งแต่ต้นว่าการฝึกงานนอกมหาวิทยาลัยนับเป็น **off-campus employment** ซึ่งผู้ถือ J-1 ทำเองไม่ได้ ต้องขออนุญาตผ่านช่องทางที่เรียกว่า **Academic Training (AT)** (คนละตัวกับ OPT/CPT ของ F-1) และต้องได้**อนุมัติเป็นลายลักษณ์อักษรจาก RO/ARO ก่อนเริ่มงานเสมอ**

กฎที่กระทบการหาที่ฝึกงานโดยตรง: **งานต้องเกี่ยวข้องโดยตรงกับสาขาที่เรียน (major field of study)** และ AT ผูกกับ**ตำแหน่งและนายจ้างเฉพาะราย** — เปลี่ยนที่ทำงานเมื่อไหร่ต้องยื่นขออนุมัติใหม่ทุกครั้ง ดังนั้นตอนหางานอย่ามองแค่ว่ารับหรือไม่รับ ต้องดูด้วยว่า**ตรงสาขาพอที่จะผ่านการอนุมัติหรือเปล่า** และเผื่อเวลายื่นเรื่องก่อนวันเริ่มงานไว้ล่วงหน้า

*(รายละเอียดเงื่อนไข AT แบบเต็ม — เอกสารที่ต้องใช้ เพดานระยะเวลา และขั้นตอนยื่น — จะแยกเขียนเป็นตอนใหม่ทีหลัง)*
...
### ระเบียบนักเรียนทุนที่ควรอ่านก่อน ไม่ใช่ตอนที่ต้องใช้

ประกันสุขภาพเป็นแค่เรื่องเดียวที่ สนร. ดูแล — เรื่องที่เหลือเกือบทั้งหมดระหว่างที่เรียนอยู่ก็อยู่ในความดูแลของ สนร. เช่นกัน และมีระเบียบเขียนไว้ชัดเจนแล้วทุกเรื่อง รวมอยู่ที่หน้าเดียว: [ระเบียบนักเรียนทุนทุกระดับ — oeadc.org](https://oeadc.org/th/page/regulations-for-all) แยกเป็น 2 หมวดใหญ่

<div class="callout lesson">
<p class="callout-label">สิ่งที่มีระเบียบกำหนดไว้แล้ว (อ่านหัวข้อไว้ก่อน จะได้รู้ว่าต้องขออนุมัติอะไรบ้าง)</p>

**[ระเบียบด้านการศึกษา](https://oeadc.org/th/page/educational-regulations-for-all)** — เรื่องที่ต้อง "ขอ" ก่อนทำ ไม่ใช่ทำแล้วค่อยแจ้ง:

- การขอเปลี่ยนแนวการศึกษาหรือวิชาที่จะศึกษา
- การย้ายสถานศึกษา / การเปลี่ยนประเทศศึกษา
- การขยายเวลาศึกษา
- การรายงานผลการศึกษา
- การฝึกงานภายหลังสำเร็จการศึกษา และการฝึกอบรมวิจัยหลังสำเร็จการศึกษาระดับปริญญาเอก (Postdoctoral)
- การกลับเยี่ยมบ้านชั่วคราว และการขอไปทัศนศึกษานอกประเทศที่ศึกษาโดยไม่กลับประเทศไทย
- การรายงานตัวหลังสำเร็จการศึกษา

**[ระเบียบด้านการเงิน](https://oeadc.org/th/page/financial-regulations-for-all)** — มีรายการที่เบิกได้มากกว่าที่คนส่วนใหญ่รู้:

- ค่าใช้จ่ายก่อนเดินทาง · ค่าใช้จ่ายประจำเดือนงวดแรก · ค่าตั๋วโดยสารเครื่องบินในการเดินทางไปศึกษา
- ค่าเครื่องและอุปกรณ์คอมพิวเตอร์
- ค่าใช้จ่ายประจำเดือนระหว่างศึกษา · ค่าเล่าเรียน · ค่าหนังสือและอุปกรณ์การศึกษา
- ค่าทดสอบ ค่าส่งผลสอบ ค่าสมัครสถานศึกษา
- ค่าใช้จ่ายในการกลับมาเก็บข้อมูลเพื่อทำวิทยานิพนธ์นอกประเทศที่ศึกษา
- การไปร่วมประชุมหรือสัมมนาทางวิชาการ
- ค่าเดินทางกลับประเทศไทยหลังสำเร็จการศึกษา

</div>

ที่อยากให้อ่านตั้งแต่ตอนนี้ ไม่ใช่ตอนที่ต้องใช้จริง เพราะสองอย่าง: **หมวดการศึกษาเกือบทั้งหมดเป็นเรื่องที่ต้องขออนุมัติล่วงหน้า** ถ้าทำไปก่อนแล้วค่อยรายงานอาจมีปัญหาย้อนหลังได้ (เช่น ค่าทดสอบภาษาหรือค่าสมัครมหาวิทยาลัยที่จ่ายไปแล้ว หากรู้ทีหลังว่าเบิกได้ ก็อาจเลยกรอบเวลาที่ยื่นเบิกได้) และหน้านี้ยังลิงก์ไป [กฎหมาย/ระเบียบ ข้อบังคับสำนักงาน ก.พ.](https://oeadc.org/th/page/oeadc-laws-and-regulations) ซึ่งเป็นตัวบทที่ใช้อ้างอิงจริงเวลามีข้อโต้แย้ง

หมายเหตุ: หน้านี้เป็นระเบียบของ **นักเรียนทุนทุกระดับ (ยกเว้นระดับมัธยมศึกษา ซึ่งแยกไว้[อีกหน้าหนึ่ง](https://oeadc.org/th/page/regulations-for-secondary-school-scholarship-students))** — แต่ถ้าเป็น **ข้าราชการลาศึกษา** เหมือนกรณีของผม สิทธิบางรายการอาจต่างจากนักเรียนทุน ก.พ. โดยตรง เพราะต้นสังกัดเป็นผู้ออกค่าใช้จ่ายเอง เช่นเดียวกับเรื่องประกันสุขภาพข้างต้นที่ ว3 ต่างจาก ว1 — **ให้ยึดสัญญาทุนและระเบียบของต้นสังกัดตัวเองเป็นหลัก แล้วใช้หน้านี้เป็นตัวตั้งต้นในการถาม** ไม่ใช่คำตอบสุดท้าย
...
- [สนร. — ระเบียบนักเรียนทุนทุกระดับ](https://oeadc.org/th/page/regulations-for-all) — รวมระเบียบระหว่างศึกษาไว้ที่เดียว แยกเป็น [ระเบียบด้านการศึกษา](https://oeadc.org/th/page/educational-regulations-for-all) (เปลี่ยนสาขา/ย้ายสถานศึกษา/ขยายเวลา/รายงานผล/ฝึกงานหลังจบ/กลับเยี่ยมบ้าน/รายงานตัวหลังสำเร็จการศึกษา) และ [ระเบียบด้านการเงิน](https://oeadc.org/th/page/financial-regulations-for-all) (ค่าเล่าเรียน/ค่าใช้จ่ายประจำเดือน/ค่าหนังสือ/ค่าคอมพิวเตอร์/ค่าสอบ/ค่าประชุมวิชาการ/ค่าตั๋วกลับไทย) — ระดับมัธยมศึกษาแยกอยู่[อีกหน้าหนึ่ง](https://oeadc.org/th/page/regulations-for-secondary-school-scholarship-students)
- [สนร. — กฎหมาย/ระเบียบ ข้อบังคับสำนักงาน ก.พ.](https://oeadc.org/th/page/oeadc-laws-and-regulations)
